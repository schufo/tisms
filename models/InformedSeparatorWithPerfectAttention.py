...
class InformedSeparatorWithPerfectAttention(nn.Module):
    ...
    def __init__(self, mix_features, mix_encoding_size, mix_encoder_layers, side_info_features,
        ...
        super(InformedSeparatorWithPerfectAttention, self).__init__()
        ...
        if side_info_encoder_bidirectional:
            ...
            self.attention = FakeAttentionMechanism(2 * side_info_encoding_size, 2 * mix_encoding_size)
            ...
            self.attention = FakeAttentionMechanism(side_info_encoding_size, 2 * mix_encoding_size)
    ...
    def forward(self, mix_input, side_info, alphas):
        """
        ...
        context_vector, alphas = self.attention(self.side_info_encoding, self.mix_encoding, alphas)
...
class FakeAttentionMechanism(nn.Module):
    ...
    def __init__(self, side_info_encoding_size, mix_encoding_size):
        ...
        """
        super(FakeAttentionMechanism, self).__init__()
    ...
    def forward(self, side_info_encoding, mix_encoding, alphas):
        ...
        :param alphas: perfect attention weights, shape: (batch_size, N, M)
