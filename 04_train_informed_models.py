...
def configuration():
    ...
    comment = 'informed model'


@ex.capture
def make_model(model, fft_len, mix_encoder_layers, side_info_encoder_layers, target_decoder_layers,
...
@ex.capture
def idx2onehot(phonemes_batched):
    ...
    for i in range(epochs):
        ...
        for i_batchV, sample_batchedV in enumerate(dataloader_val):
            ...
            with torch.no_grad():
                ...
                prediction, alphas = fct.predict_with_attention(model_to_train.to(device),
